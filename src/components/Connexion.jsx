...
const Connexion = () => {
    ...
    return (
        <div className="compte-body">
            ...
            <button onClick={() => forgotPassword(email)} className="mdp-oblie">Mot de passe oublié ?</button>
            <button onClick={() => connexion(email, mdp)} className="btnDeco">Connexion</button>
        </div>
    )
}
